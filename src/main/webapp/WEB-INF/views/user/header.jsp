							...
							<li class="header-nav__item js-nav-item">
								...
								<div class="hide-nav js-nav-hide">
									<ul class="hide-nav__list">
										...
										<li class="hide-nav__item">
											<a class="hide-nav__link footer__cols" style="border-bottom: 0" href="index?lang=vn">
												<span class="footer__left">
								...
								<div class="hide-nav js-nav-hide">
									<ul class="hide-nav__list">
										...
										<c:if test="${not empty isLogin}">
											...
											<li class="hide-nav__item">
												<a class="hide-nav__link" href="myorder/${user.getUsername()}">
													<s:message code="user.myorder" />
												</a>
											</li>
