...
public class CheckoutController {
	...
	public String success(Model model, @RequestParam("phone") String phone, @RequestParam("address") String address) {
		...
		dao.save(order);
		// phương thức này xử lý yêu cầu thanh toán và tạo đơn hàng mới. Nó lưu thông
		// tin đơn hàng vào cơ sở dữ liệu, tạo và lưu các chi tiết đơn hàng, xóa tất cả
		// các mục hàng trong giỏ hàng và chuyển hướng đến trang thành công.
