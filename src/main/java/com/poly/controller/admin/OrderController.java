...
public class OrderController {
	...
	public String view(Model model) {
		...
		// thêm đối tượng vào item tìm dữ liệu trên data
		return "admin/order";
	}
	...
	public String viewOrderDetails(Model model, @PathVariable("id") Integer id) {
		...
		// ấy danh sách chi tiết đơn hàng dựa trên id đơn hàng, tính tổng số tiền và
		// thêm danh sách và tổng số tiền vào Model
	}
}
